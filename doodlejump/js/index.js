...
function Platform() {
  ...
  if (score >= 5000) {gravity =0.1;}
	else if (score >= 2000 && score < 5000) {gravity =0.5;}
	else if (score >= 1000 && score < 2000) {gravity =0.4;}
	else if (score >= 500 && score < 1000) {gravity =0.3;}
	else if (score >= 100 && score < 500) {gravity =0.2;}
	else {gravity =0.1;}
