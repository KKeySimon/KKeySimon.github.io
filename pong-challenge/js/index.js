// first variable is for information about the dimensions of the canvas object
               ...
               const PADDLE_HEIGHT1 = 300;
               const PADDLE_WIDTH1= 10;
               ...
               function drawNet() {
                 ...
                 function drawEverything() {
                     // Create Backdrop
                     rect(0,0,canvas.width,canvas.height, '#80FF02');
                     ...
                     // Create paddle left
                     rect(0,paddleLY,PADDLE_WIDTH1,PADDLE_HEIGHT1, '#dadada');
                ...
                function moveEverything() {
                    ...
                    // Moves the ball horizontally
                        ...
                        if (ballX-ballSize < 0) {
                            if(ballY > paddleLY &&
                               ballY < paddleLY+PADDLE_HEIGHT1) {
                                ballSpeedX = -ballSpeedX;

                                var deltaY = ballY
                                            -(paddleLY + PADDLE_HEIGHT1/2);
